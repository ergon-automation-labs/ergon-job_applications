defmodule BotArmyJobApplications.Repo.Migrations.AddTenantAndUserId do
  ...
  def up do
    ...
    if not Ecto.Migration.column_exists?(:resumes, :tenant_id) do
    ...
    if not Ecto.Migration.column_exists?(:resume_skills, :tenant_id) do
    ...
    if not Ecto.Migration.column_exists?(:resume_roles, :tenant_id) do
    ...
    if not Ecto.Migration.column_exists?(:resume_bullets, :tenant_id) do
    ...
    if not Ecto.Migration.column_exists?(:listings, :tenant_id) do
    ...
    if not Ecto.Migration.column_exists?(:applications, :tenant_id) do
  ...
  def down do
    ...
    drop(index(:resumes, [:tenant_id]))
    drop(index(:resumes, [:user_id]))
    ...
    drop(index(:resume_skills, [:tenant_id]))
    drop(index(:resume_skills, [:user_id]))
    ...
    drop(index(:resume_roles, [:tenant_id]))
    drop(index(:resume_roles, [:user_id]))
    ...
    drop(index(:resume_bullets, [:tenant_id]))
    drop(index(:resume_bullets, [:user_id]))
    ...
    drop(index(:listings, [:tenant_id]))
    drop(index(:listings, [:user_id]))
    ...
    drop(index(:applications, [:tenant_id]))
    drop(index(:applications, [:user_id]))
